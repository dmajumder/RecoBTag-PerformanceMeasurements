...
variableList = [
    ...
    cms.PSet(
      variable    = cms.string("Jet_DeepAK8_Hbb"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_DeepAK8_Hbb"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
      variable    = cms.string("Jet_DeepAK8_ZHbb"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_DeepAK8_ZHbb"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
      variable    = cms.string("Jet_particleNet_probXbbvsQCD"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_particleNet_probXbbvsQCD"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
      variable    = cms.string("Jet_particleNet_probQCDbb"),
      store       = cms.bool(False),
      mconly      = cms.bool(False),
      description = cms.string("Jet_particleNet_probQCDbb"),
      requires    = cms.vstring("nJet"),
      runOptions  = cms.vstring(),
    ),
    cms.PSet(
